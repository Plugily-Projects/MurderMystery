...
public enum Locale {
  ...
  CHINESE_SIMPLIFIED("简体中文", "zh_Hans", "POEditor contributors (壁灯)", Arrays.asList("简体中文", "chinese", "zh")),
  CHINESE_TRADITIONAL("简体中文", "zh_HK", "POEditor contributors (ColaIan)", Arrays.asList("中文(傳統)", "中國傳統", "chinese_traditional", "zh_hk")),
